        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/templates" className="hover:text-primary-foreground transition-colors">Templates</Link></li>
              <li><Link href="/#how-it-works" className="hover:text-primary-foreground transition-colors">How It Works</Link></li>
              <li><Link href="/builder" className="hover:text-primary-foreground transition-colors">Resume Builder</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-primary-foreground mb-4">Resources</h4>
            <ul className="space-y-2 text-sm">
              <li><Link href="/blog" className="hover:text-primary-foreground transition-colors">Career Blog</Link></li>
              <li><Link href="/blog/how-to-beat-ats-2025" className="hover:text-primary-foreground transition-colors">ATS Guide</Link></li>
              <li><Link href="/blog/resume-action-verbs" className="hover:text-primary-foreground transition-colors">Action Verbs</Link></li>
